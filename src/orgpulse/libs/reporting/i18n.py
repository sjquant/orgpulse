...
_STATIC: dict[ReportLocale, dict[str, str]] = {
    ReportLocale.EN: {
        ...
        "dashboard.dense_tables": "Dense trend tables",
        "dashboard.reference_copy": "These trend tables stay collapsed by default so large org windows do not force the main dashboard into a long scroll-only document.",
    ...
    ReportLocale.KO: {
        ...
        "dashboard.dense_tables": "상세 추세 표",
        "dashboard.reference_copy": "큰 조직 기간에서도 주요 대시보드가 길어지지 않도록 추세 표는 기본적으로 접어 둡니다.",
