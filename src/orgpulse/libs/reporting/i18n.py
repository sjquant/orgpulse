...
_STATIC: dict[ReportLocale, dict[str, str]] = {
    ReportLocale.EN: {
        ...
        "person.subtitle_suffix": "Reviewer activity is counted by review submission time.",
        ...
        "metric.reviews_given": "review submissions",
        ...
        "person.org_average_comparison": "Org average",
    ...
    ReportLocale.KO: {
        ...
        "person.subtitle_suffix": "리뷰어 활동은 리뷰 제출 시간을 기준으로 집계합니다.",
        "theme.color": "색상 테마",
        "theme.dark": "어두운 테마",
        "theme.light": "밝은 테마",
        "common.window": "기간",
        ...
        "person.org_average_comparison": "조직 1인 평균",
...
_METRICS: dict[ReportLocale, dict[str, dict[str, str]]] = {
    ReportLocale.EN: {
        ...
        "review_submissions_given": {
            ...
            "description": "GitHub review events submitted by the selected person.",
        },
    ...
    ReportLocale.KO: {
        ...
        "review_submissions_given": {
            "label": "리뷰 제출 수",
            "description": "선택한 사람이 제출한 GitHub 리뷰 이벤트 수입니다.",
        },
        "pull_requests_reviewed": {
            "label": "리뷰한 PR",
