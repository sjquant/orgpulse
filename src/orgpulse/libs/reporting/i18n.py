...
_STATIC: dict[ReportLocale, dict[str, str]] = {
    ReportLocale.EN: {
        ...
        "dashboard.subtitle": "A snapshot of review throughput, review load, and repository flow for the selected period.",
    ...
    ReportLocale.KO: {
        ...
        "dashboard.subtitle": "선택한 기간의 리뷰 처리량, 리뷰 부담, 저장소별 작업 흐름을 한눈에 봅니다.",
        ...
        "dashboard.people_copy": "지표를 선택하면 그 신호를 만든 사람이 먼저 보입니다. 사람을 선택하면 오른쪽에서 상세 흐름을 확인할 수 있습니다.",
        ...
        "dashboard.dense_tables": "기간별 상세 데이터",
